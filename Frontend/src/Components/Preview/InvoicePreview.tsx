    ...
    <div className="preview-container">
      ...
      <div ref={previewRef}>
        ...
        <div className="title-section">
          <h2>TAX INVOICE</h2>
          <div>
            <EditableSpan>MS/26-27/GST-001</EditableSpan>
          </div>
          <div>
        ...
        <div className="bottom-section">
          <div className="terms-col">
            ...
            <p>
              <EditableSpan>
                - Fully paid Invoice OR Payment due date XXXXth Feb 2026 – 5100%
              </EditableSpan>
            </p>
            <p>
              <EditableSpan>
                - Delivery: Electronic Software Delivery.
              </EditableSpan>
            </p>
            <p>
              <EditableSpan>
            ...
            <div style={{ marginTop: "15px" }}>
              ...
              <div>
                <EditableSpan>ACCOUNT NUMBER: 911618000</EditableSpan>
              </div>
              <div>
                <EditableSpan>IFSC: UTIB0007733</EditableSpan>
              </div>
              <div>
            ...
            <table className="totals-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "right", backgroundColor: "yellow" }}>
                    <EditableSpan>( - ) 5,xxxxx0.00</EditableSpan>
                  </td>
                </tr>
                <tr>
                  <td style={{ textAlign: "right" }}>IGST @18%</td>
                  <td style={{ textAlign: "right" }}>7XXXXXX74.00</td>
                </tr>
                <tr>
        ...
        <div className="amount-words-container">
          ...
          <div>Eight five thxxxxxx. XXXX XXXXXred eighty six only</div>
        </div>
